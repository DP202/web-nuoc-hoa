...
if (isset($_GET['search'])) {
    ...
    $foundProducts = false; // Khởi tạo biến để kiểm tra xem có sản phẩm nào được tìm thấy hay không

    while ($row_product = mysqli_fetch_array($query_product)) {
        $foundProducts = true; // Đặt biến thành true khi có sản phẩm được tìm thấy
        ?>
